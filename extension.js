...
function activate(context) {
  console.log(
    'Congratulations, your extension "postcss-auto-comments" is now active!'
  );
  let config = {
    verboseSelectors: vscode.workspace
      .getConfiguration()
      .get('cssRulesetComments.verboseSelectors'),
    includeMediaQueries: vscode.workspace
      .getConfiguration()
      .get('cssRulesetComments.includeMediaQueries'),
    formatterEnable: vscode.workspace
      .getConfiguration()
      .get('cssRulesetComments.formatterEnable'), 
  };

  let disposable = vscode.commands.registerCommand('extension.formatCSSRulesetComments', function () {
  ...
  if (config.formatterEnable) {
    vscode.languages.registerDocumentFormattingEditProvider('PostCSS', {
